...
class Num2WordsLVTest(TestCase):
    def test_to_cardinal(self):
        ...
        self.assertEqual(num2words(2012, lang="lv"), "divi tūkstoši divpadsmit")
        self.assertEqual(
        ...
        self.assertEqual(num2words(10.02, lang="lv"), "desmit komats nulle divi")
        self.assertEqual(
            num2words(15.007, lang="lv"), "piecpadsmit komats nulle nulle septiņi"
        )
        ...
        self.assertEqual(
            num2words(10111, lang="lv"), "desmit tūkstoši simts vienpadsmit"
        )
        self.assertEqual(num2words(1135, lang="lv"), "tūkstotis simts trīsdesmit pieci")
        self.assertEqual(
            num2words(418531, lang="lv"),
            "četri simti astoņpadsmit tūkstoši pieci simti trīsdesmit viens",
        )
        self.assertEqual(
            num2words(1000139, lang="lv"), "miljons simts trīsdesmit deviņi"
        )
    ...
    def test_to_currency(self):
        self.assertEqual(
            num2words(1, lang="lv", to="currency", currency="EUR"), "viens eiro"
        )
        self.assertEqual(
            num2words(1, lang="lv", to="currency", currency="LVL"), "viens lats"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            num2words(10111, lang="lv", to="currency", separator=" un", currency="EUR"),
            "desmit tūkstoši simts vienpadsmit eiro",
        )
        self.assertEqual(
            num2words(10121, lang="lv", to="currency", separator=" un", currency="LVL"),
            "desmit tūkstoši simts divdesmit viens lati",
        )
        self.assertEqual(
            num2words(-1251985, lang="lv", to="currency", cents=False, currency="EUR"),
