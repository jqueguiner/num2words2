...
class Num2WordsFATest(TestCase):
    ...
    def test_ordinal(self):
        self.assertEqual(num2words(0, lang="fa", to="ordinal"), "صفرم")
        self.assertEqual(num2words(1, lang="fa", to="ordinal"), "یکم")
        self.assertEqual(num2words(13, lang="fa", to="ordinal"), "سیزدهم")
        self.assertEqual(num2words(23, lang="fa", to="ordinal"), "بیست و سوم")
        self.assertEqual(num2words(12, lang="fa", to="ordinal"), "دوازدهم")
        self.assertEqual(num2words(113, lang="fa", to="ordinal"), "صد و سیزدهم")
        self.assertEqual(num2words(103, lang="fa", to="ordinal"), "صد و سوم")
    ...
    def test_year(self):
        self.assertEqual(
            num2words(1398, lang="fa", to="year"), "هزار و سیصد و نود و هشت"
        )
        self.assertEqual(
            num2words(1399, lang="fa", to="year"), "هزار و سیصد و نود و نه"
        )
    ...
    def test_currency(self):
        ...
        self.assertEqual(
            num2words(1500000, lang="fa", to="currency"), "یک میلیون و پانصد هزار تومان"
        )
