...
class Num2WordsVITest(TestCase):
    ...
    def test_100_to_999(self):
        ...
        self.assertEqual(num2words(196, lang="vi"), "một trăm chín mươi sáu")
    ...
    def test_1000_to_9999(self):
        ...
        self.assertEqual(num2words(7378, lang="vi"), "bảy nghìn ba trăm bảy mươi tám")
        self.assertEqual(num2words(2000, lang="vi"), "hai nghìn")
        self.assertEqual(num2words(2100, lang="vi"), "hai nghìn một trăm")
        self.assertEqual(num2words(6870, lang="vi"), "sáu nghìn tám trăm bảy mươi")
    ...
    def test_big(self):
        ...
        self.assertEqual(num2words(1200000, lang="vi"), "một triệu hai trăm nghìn")
        self.assertEqual(num2words(3000000, lang="vi"), "ba triệu")
        self.assertEqual(num2words(3800000, lang="vi"), "ba triệu tám trăm nghìn")
        self.assertEqual(num2words(1000000000, lang="vi"), "một tỷ")
        self.assertEqual(num2words(2000000000, lang="vi"), "hai tỷ")
        self.assertEqual(num2words(2000001000, lang="vi"), "hai tỷ một nghìn")
        self.assertEqual(
    ...
    def test_decimal_number(self):
        self.assertEqual(num2words(1000.11, lang="vi"), "một nghìn phẩy mười một")
        self.assertEqual(num2words(1000.21, lang="vi"), "một nghìn phẩy hai mươi mốt")
    ...
    def test_special_number(self):
        ...
        self.assertEqual(
            num2words(98765, lang="vi"), "chín mươi tám nghìn bảy trăm sáu mươi lăm"
        )
        ...
        # > 1000000000
        self.assertEqual(num2words(1000000017, lang="vi"), "một tỷ lẻ mười bảy")
        self.assertEqual(
