...
class Num2WordsRUTest(TestCase):
    def test_cardinal(self):
        ...
        self.assertEqual(num2words(1135, lang="ru"), "одна тысяча сто тридцать пять")
        self.assertEqual(
    ...
    def test_floating_point(self):
        ...
        self.assertEqual(num2words("5.10", lang="ru"), "пять целых десять сотых")
        self.assertEqual(num2words(1.001, lang="ru"), "одна целая одна тысячная")
        self.assertEqual(num2words(1.011, lang="ru"), "одна целая одиннадцать тысячных")
        self.assertEqual(num2words(10.02, lang="ru"), "десять целых две сотых")
        self.assertEqual(num2words(15.007, lang="ru"), "пятнадцать целых семь тысячных")
        self.assertEqual(
            num2words(561.42, lang="ru"),
            "пятьсот шестьдесят одна целая сорок две сотых",
        )
        self.assertEqual(
            num2words(561.00001, lang="ru"),
    ...
    def test_to_ordinal(self):
        ...
        self.assertEqual(num2words(5, lang="ru", to="ordinal"), "пятый")
        self.assertEqual(num2words(10, lang="ru", to="ordinal"), "десятый")

        self.assertEqual(num2words(13, lang="ru", to="ordinal"), "тринадцатый")
        self.assertEqual(num2words(20, lang="ru", to="ordinal"), "двадцатый")
        self.assertEqual(num2words(23, lang="ru", to="ordinal"), "двадцать третий")
        self.assertEqual(num2words(40, lang="ru", to="ordinal"), "сороковой")
        self.assertEqual(num2words(70, lang="ru", to="ordinal"), "семидесятый")
        self.assertEqual(num2words(100, lang="ru", to="ordinal"), "сотый")
        self.assertEqual(num2words(136, lang="ru", to="ordinal"), "сто тридцать шестой")
        self.assertEqual(num2words(500, lang="ru", to="ordinal"), "пятисотый")
        self.assertEqual(num2words(1000, lang="ru", to="ordinal"), "тысячный")
        self.assertEqual(num2words(1001, lang="ru", to="ordinal"), "тысяча первый")
        self.assertEqual(
            num2words(1060, lang="ru", to="ordinal"), "тысяча шестидесятый"
        )
        self.assertEqual(num2words(2000, lang="ru", to="ordinal"), "двухтысячный")
        self.assertEqual(num2words(10000, lang="ru", to="ordinal"), "десятитысячный")
        self.assertEqual(num2words(90000, lang="ru", to="ordinal"), "девяностотысячный")
        self.assertEqual(
            num2words(21000, lang="ru", to="ordinal"), "двадцатиоднотысячный"
        )
        self.assertEqual(
            num2words(130000, lang="ru", to="ordinal"), "стотридцатитысячный"
        )
        self.assertEqual(
            num2words(135000, lang="ru", to="ordinal"), "стотридцатипятитысячный"
        )
        self.assertEqual(
            num2words(135100, lang="ru", to="ordinal"), "сто тридцать пять тысяч сотый"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            num2words(190000, lang="ru", to="ordinal"), "стодевяностотысячный"
        )
        self.assertEqual(num2words(1000000, lang="ru", to="ordinal"), "миллионный")
        self.assertEqual(num2words(2000000, lang="ru", to="ordinal"), "двухмиллионный")
        self.assertEqual(
            num2words(5135000, lang="ru", to="ordinal"),
            "пять миллионов стотридцатипятитысячный",
        )
        self.assertEqual(
            num2words(21000000, lang="ru", to="ordinal"), "двадцатиодномиллионный"
        )
        self.assertEqual(num2words(1000000000, lang="ru", to="ordinal"), "миллиардный")
        self.assertEqual(
    ...
    def test_to_ordinal_feminine(self):
        ...
        self.assertEqual(
            num2words(23, lang="ru", to="ordinal", gender="f"), "двадцать третья"
        )
        self.assertEqual(
            num2words(1000, lang="ru", to="ordinal", gender="f"), "тысячная"
        )
        self.assertEqual(
            num2words(2000000, lang="ru", to="ordinal", gender="f"), "двухмиллионная"
        )
    ...
    def test_to_ordinal_neuter(self):
        ...
        self.assertEqual(
            num2words(23, lang="ru", to="ordinal", gender="n"), "двадцать третье"
        )
        self.assertEqual(
            num2words(1000, lang="ru", to="ordinal", gender="n"), "тысячное"
        )
        self.assertEqual(
            num2words(2000000, lang="ru", to="ordinal", gender="n"), "двухмиллионное"
        )

    def test_cardinal_cases(self):
        self.assertEqual(num2words(1, lang="ru", case="nominative"), "один")
        self.assertEqual(num2words(1, lang="ru", case="genitive"), "одного")
        self.assertEqual(
            num2words(1, lang="ru", case="a", plural=True, animate=False), "одни"
        )
        self.assertEqual(
            num2words(2, lang="ru", case="a", gender="f", animate=True), "двух"
        )
        self.assertEqual(
            num2words(2, lang="ru", case="a", gender="f", animate=False), "две"
        )
        self.assertEqual(num2words(100, lang="ru", case="g"), "ста")
        self.assertEqual(num2words(122, lang="ru", case="d"), "ста двадцати двум")
        self.assertEqual(num2words(1000, lang="ru", case="p"), "одной тысяче")
        self.assertEqual(
            num2words(1122, lang="ru", case="p"), "одной тысяче ста двадцати двух"
        )
        self.assertEqual(
    ...
    def test_ordinal_cases(self):
        ...
        self.assertEqual(
            num2words(1, lang="ru", to="ordinal", case="a", plural=True, animate=False),
            "первые",
        )
        self.assertEqual(
            num2words(2, lang="ru", to="ordinal", case="a", gender="f", animate=True),
            "вторую",
        )
        self.assertEqual(
            num2words(2, lang="ru", to="ordinal", case="a", gender="f", animate=False),
            "вторую",
        )
        self.assertEqual(num2words(100, lang="ru", to="ordinal", case="g"), "сотого")
        self.assertEqual(
            num2words(122, lang="ru", to="ordinal", case="d"), "сто двадцать второму"
        )
        self.assertEqual(num2words(1000, lang="ru", to="ordinal", case="p"), "тысячном")
        self.assertEqual(
    ...
    def test_to_currency(self):
        self.assertEqual(
            num2words(1, lang="ru", to="currency", currency="EUR"), "один евро"
        )
        self.assertEqual(
            num2words(1, lang="ru", to="currency", currency="RUB"), "один рубль"
        )
        self.assertEqual(
            num2words(1, lang="ru", to="currency", currency="UAH"), "один гривна"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            num2words(10111, lang="ru", to="currency", currency="EUR", separator=" и"),
            "десять тысяч сто одиннадцать евро",
        )
        self.assertEqual(
            num2words(10111, lang="ru", to="currency", currency="RUB", separator=" и"),
            "десять тысяч сто одиннадцать рублей",
        )
        self.assertEqual(
            num2words(10111, lang="ru", to="currency", currency="UAH", separator=" и"),
            "десять тысяч сто одиннадцать гривен",
        )
        self.assertEqual(
            num2words(10121, lang="ru", to="currency", currency="EUR", separator=" и"),
            "десять тысяч сто двадцать один евро",
        )
        self.assertEqual(
            num2words(10121, lang="ru", to="currency", currency="RUB", separator=" и"),
            "десять тысяч сто двадцать один рубль",
        )
        self.assertEqual(
            num2words(10121, lang="ru", to="currency", currency="UAH", separator=" и"),
            "десять тысяч сто двадцать один гривна",
        )
        self.assertEqual(
            num2words(10122, lang="ru", to="currency", currency="EUR", separator=" и"),
            "десять тысяч сто двадцать два евро",
        )
        self.assertEqual(
            num2words(10122, lang="ru", to="currency", currency="RUB", separator=" и"),
            "десять тысяч сто двадцать два рубля",
        )
        self.assertEqual(
            num2words(10122, lang="ru", to="currency", currency="UAH", separator=" и"),
            "десять тысяч сто двадцать два гривны",
        )
        self.assertEqual(
            num2words(-1251985, lang="ru", to="currency", currency="EUR", cents=False),
            "минус один миллион двести пятьдесят одна тысяча девятьсот восемьдесят пять евро",
        )
        self.assertEqual(
            num2words(-1251985, lang="ru", to="currency", currency="RUB", cents=False),
            "минус один миллион двести пятьдесят одна тысяча девятьсот восемьдесят пять рублей",
        )
        self.assertEqual(
            num2words(-1251985, lang="ru", to="currency", currency="UAH", cents=False),
        ...
        self.assertEqual(
            num2words(10122, lang="ru", to="currency", currency="UZS", separator=" и"),
