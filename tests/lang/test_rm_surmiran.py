...
class Num2WordsRMSURMIRANTest(TestCase):
    ...
    def test_float_to_cardinal(self):
        self.assertEqual(
            num2words(3.1415, lang="rm_surmiran"),
            "treis comma en quatter en tschintg")
        self.assertEqual(
            num2words(-5.15, lang="rm_surmiran"),
            "minus tschintg comma en tschintg")
        self.assertEqual(
            num2words(-0.15, lang="rm_surmiran"),
    ...
    def test_0(self):
        ...
        self.assertEqual(num2words(0, lang="rm_surmiran", ordinal=True),
                         "nolla")
    ...
    def test_100_to_999(self):
        ...
        self.assertEqual(
            num2words(105, lang="rm_surmiran"), "tschentatschintg")
        ...
        self.assertEqual(
            num2words(111, lang="rm_surmiran"), "tschentadendesch")
        self.assertEqual(
            num2words(112, lang="rm_surmiran"), "tschentadodesch")
        self.assertEqual(
            num2words(113, lang="rm_surmiran"), "tschentatredesch")
        self.assertEqual(
            num2words(114, lang="rm_surmiran"), "tschentquittordesch")
        self.assertEqual(
            num2words(115, lang="rm_surmiran"), "tschentaquindesch")
        self.assertEqual(
            num2words(116, lang="rm_surmiran"), "tschentasedesch")
        self.assertEqual(
            num2words(117, lang="rm_surmiran"), "tschentdischset")
        self.assertEqual(
            num2words(118, lang="rm_surmiran"), "tschentdischdotg")
        self.assertEqual(
            num2words(119, lang="rm_surmiran"), "tschentdischnov")
        self.assertEqual(
            num2words(120, lang="rm_surmiran"), "tschentavantg")
        self.assertEqual(
            num2words(121, lang="rm_surmiran"), "tschentvantgegn")
        self.assertEqual(
            num2words(122, lang="rm_surmiran"), "tschentvantgadus")
        self.assertEqual(
            num2words(123, lang="rm_surmiran"), "tschentvantgatreis")
        self.assertEqual(
            num2words(124, lang="rm_surmiran"), "tschentvantgaquatter")
        self.assertEqual(
            num2words(125, lang="rm_surmiran"), "tschentvantgatschintg")
        self.assertEqual(
            num2words(126, lang="rm_surmiran"), "tschentvantgaseis")
        self.assertEqual(
            num2words(127, lang="rm_surmiran"), "tschentvantgaset")
        self.assertEqual(
            num2words(128, lang="rm_surmiran"), "tschentvantgotg")
        self.assertEqual(
            num2words(129, lang="rm_surmiran"), "tschentvantganov")
        ...
        self.assertEqual(
            num2words(150, lang="rm_surmiran"), "tschenttschuncanta")
        self.assertEqual(
            num2words(196, lang="rm_surmiran"), "tschentnovantaseis")
        self.assertEqual(num2words(200, lang="rm_surmiran"), "dutschent")
        self.assertEqual(num2words(208, lang="rm_surmiran"), "dutschentadotg")
        self.assertEqual(
            num2words(210, lang="rm_surmiran"), "dutschentadiesch")
        self.assertEqual(
            num2words(271, lang="rm_surmiran"), "dutschentsettantegn")
        ...
        self.assertEqual(
            num2words(311, lang="rm_surmiran"), "tretschentadendesch")
        self.assertEqual(
            num2words(375, lang="rm_surmiran"), "tretschentsettantatschintg")
        self.assertEqual(num2words(400, lang="rm_surmiran"), "quattertschent")
        self.assertEqual(
            num2words(409, lang="rm_surmiran"), "quattertschentanov")
        self.assertEqual(
            num2words(410, lang="rm_surmiran"), "quattertschentadiesch")
        self.assertEqual(
            num2words(472, lang="rm_surmiran"), "quattertschentsettantadus")
    ...
    def test_1000_to_9999(self):
        ...
        self.assertEqual(
            num2words(1101, lang="rm_surmiran"), "mellatschentadegn")
        self.assertEqual(
            num2words(1132, lang="rm_surmiran"), "mellatschenttrentadus")
        self.assertEqual(
            num2words(1500, lang="rm_surmiran"), "mellatschintgtschent")
        self.assertEqual(
            num2words(
                7378, lang="rm_surmiran"), "setmellatretschentsettantotg")
        ...
        self.assertEqual(
            num2words(2101, lang="rm_surmiran"), "dumellatschentadegn")
        self.assertEqual(num2words(3000, lang="rm_surmiran"), "tremella")
        self.assertEqual(
            num2words(3012, lang="rm_surmiran"), "tremelladodesch")
        self.assertEqual(
            num2words(
                6870, lang="rm_surmiran"), "seismellaotgtschentsettanta")
        self.assertEqual(num2words(10000, lang="rm_surmiran"), "dieschmella")
        self.assertEqual(
            num2words(10001, lang="rm_surmiran"), "dieschmelladegn")
        self.assertEqual(
    ...
    def test_big(self):
        ...
        self.assertEqual(
            num2words(1000007, lang="rm_surmiran"), "en milliun a set")
        self.assertEqual(
            num2words(1000008, lang="rm_surmiran"), "en milliun ad otg")
        self.assertEqual(
            num2words(
                1200000, lang="rm_surmiran"), "en milliun dutschentmella")
        self.assertEqual(
            num2words(2000000, lang="rm_surmiran"), "dus milliuns")
        self.assertEqual(
            num2words(2000004, lang="rm_surmiran"), "dus milliuns a quatter")
        self.assertEqual(
            num2words(2000009, lang="rm_surmiran"), "dus milliuns a nov")
        self.assertEqual(
        ...
        self.assertEqual(
            num2words(3000000, lang="rm_surmiran"), "treis milliuns")
        self.assertEqual(
            num2words(
                3000005, lang="rm_surmiran"), "treis milliuns a tschintg")
        self.assertEqual(
            num2words(
                3000080, lang="rm_surmiran"), "treis milliuns ad otganta")
        self.assertEqual(
            num2words(
                20300000, lang="rm_surmiran"),
            "vantg milliuns tretschentmella")
        self.assertEqual(
            num2words(523456, lang="rm_surmiran"),
            "tschintgtschentvantgatremellaquattertschenttschuncantaseis")
        self.assertEqual(
            num2words(
                3800000, lang="rm_surmiran"), "treis milliuns otgtschentmella")
        self.assertEqual(
            num2words(1000000000, lang="rm_surmiran"), "ena milliarda")
        self.assertEqual(
            num2words(
                1000000017, lang="rm_surmiran"), "ena milliarda a dischset")
        self.assertEqual(
            num2words(
                1020300000, lang="rm_surmiran"),
            "ena milliarda vantg milliuns tretschentmella")
        self.assertEqual(
            num2words(2000000000, lang="rm_surmiran"), "dus milliardas")
        self.assertEqual(
            num2words(
                2000001000, lang="rm_surmiran"), "dus milliardas a mella")
        self.assertEqual(
            num2words(
                2003000011, lang="rm_surmiran"),
            "dus milliardas treis milliuns ad endesch")
        self.assertEqual(
            num2words(
                3000000100, lang="rm_surmiran"), "treis milliardas a tschent")
        self.assertEqual(
            num2words(
                3000002000, lang="rm_surmiran"), "treis milliardas a dumella")
        self.assertEqual(
            num2words(
                3002000100, lang="rm_surmiran"),
            "treis milliardas dus milliuns a tschent")
        self.assertEqual(
            num2words(
                3003000001, lang="rm_surmiran"),
            "treis milliardas treis milliuns ad egn")
        self.assertEqual(
            num2words(3002000101, lang="rm_surmiran"),
            "treis milliardas dus milliuns a tschentadegn")
        self.assertEqual(
            num2words(21000000000, lang="rm_surmiran"), "vantgegn milliardas")
        self.assertEqual(
            num2words(22000000000, lang="rm_surmiran"), "vantgadus milliardas")
        self.assertEqual(
        ...
        self.assertEqual(
            num2words(1000000000000, lang="rm_surmiran"), "en billiun")
        self.assertEqual(
    ...
    def test_nth_1_to_99(self):
        self.assertEqual(
            num2words(1, lang="rm_surmiran", ordinal=True), "amprem")
        self.assertEqual(
            num2words(7, lang="rm_surmiran", ordinal=True), "settavel")
        self.assertEqual(
            num2words(8, lang="rm_surmiran", ordinal=True), "otgavel")
        self.assertEqual(
            num2words(20, lang="rm_surmiran", ordinal=True), "vantgavel")
        self.assertEqual(
            num2words(21, lang="rm_surmiran", ordinal=True), "vantgegnavel")
        self.assertEqual(
            num2words(27, lang="rm_surmiran", ordinal=True), "vantgasettavel")
        self.assertEqual(
            num2words(48, lang="rm_surmiran", ordinal=True), "curantotgavel")
        self.assertEqual(
            num2words(60, lang="rm_surmiran", ordinal=True), "sessantavel")
        self.assertEqual(
            num2words(99, lang="rm_surmiran", ordinal=True), "novantanovavel")

    def test_nth_100_to_999(self):
        self.assertEqual(
            num2words(100, lang="rm_surmiran", ordinal=True), "tschentavel")
        self.assertEqual(
            num2words(
                112, lang="rm_surmiran", ordinal=True), "tschentadodeschavel")
        self.assertEqual(
            num2words(
                137, lang="rm_surmiran", ordinal=True),
            "tschenttrentasettavel")
        self.assertEqual(
            num2words(700, lang="rm_surmiran", ordinal=True), "settschentavel")

    def test_nth_1000_to_999999(self):
        self.assertEqual(
            num2words(1000, lang="rm_surmiran", ordinal=True), "mellavel")
        self.assertEqual(
            num2words(
                1001, lang="rm_surmiran", ordinal=True), "melladegnavel")
        self.assertEqual(
            num2words(
                1200, lang="rm_surmiran", ordinal=True), "melladutschentavel")
        self.assertEqual(
            num2words(8640, lang="rm_surmiran", ordinal=True),
            "otgmellaseistschentcurantavel")
        self.assertEqual(
            num2words(
                14000, lang="rm_surmiran", ordinal=True),
            "quittordeschmellavel")
        self.assertEqual(
