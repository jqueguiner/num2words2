...
CASES = [
    "nominative",
    "genitive",
    "partitive",  # grammatical
    "inessive",
    "elative",
    "illative",  # internal locative
    "adessive",
    "ablative",
    "allative",  # external locative
    "essive",
    "translative",  # essive
    "instructive",
    "abessive",
...
class Num2WordsFITest(TestCase):
    def test_low(self):
        ...
        self.assertEqual(
            n2f(8, to="cardinal", case="genitive", plural=True, prefer=["ain"]),
            "kahdeksain",
        )
    ...
    def test_mid_ord(self):
        ...
        self.assertEqual(
            ...
            (
                ...
                "tuhannenteen kahdenteensadanteen" "kolmanteenkymmenenteenneljänteen",
                ...
                "tuhannentena kahdentenasadantena" "kolmantenakymmenentenäneljäntenä",
                "tuhannenneksi kahdenneksisadanneksi"
                "kolmanneksikymmenenneksineljänneksi",
                "tuhannensin kahdensinsadansin" "kolmansinkymmenensinneljänsin",
                "tuhannennetta kahdennettasadannetta"
                "kolmannettakymmenennettäneljännettä",
                "tuhannensine kahdensinesadansine" "kolmansinekymmenensineneljänsine",
            ),
        )
        self.assertEqual(
            tuple(n2f(1234, to="ordinal", case=c, plural=True) for c in CASES),
            (
                "tuhannennet kahdennetsadannet" "kolmannetkymmenennetneljännet",
                "tuhannensien kahdensiensadansien" "kolmansienkymmenensienneljänsien",
                "tuhannensia kahdensiasadansia" "kolmansiakymmenensiäneljänsiä",
                ...
                "tuhannensiin kahdensiinsadansiin" "kolmansiinkymmenensiinneljänsiin",
                ...
                "tuhannensina kahdensinasadansina" "kolmansinakymmenensinäneljänsinä",
    ...
    def test_high(self):
        ...
        self.assertEqual(
            tuple(n2f(12345, to="cardinal", case=c, plural=True) for c in CASES),
            (
        ...
        self.assertEqual(
            ...
            (
                "sadatkahdetkymmenetkolmettuhannet " "neljätsadatviidetkymmenetkuudet",
        ...
        self.assertEqual(
            tuple(
                n2f((10**6) ** 2, to="cardinal", case=c, plural=True) for c in CASES
            ),
            (
                "biljoonat",
                "biljoonien",
        ...
        self.assertEqual(
            tuple(
                n2f((10**6) ** 3, to="cardinal", case=c, plural=True) for c in CASES
            ),
            (
                "triljoonat",
                "triljoonien",
    ...
    def test_high_ord(self):
        ...
        self.assertEqual(
            ...
            (
                "sadaskahdeskymmeneskolmastuhannes " "neljässadasviideskymmeneskuudes",
        ...
        self.assertEqual(
            tuple(
                n2f((10**6) ** 2, to="ordinal", case=c, plural=True) for c in CASES
            ),
            (
                "biljoonannet",
                "biljoonansien",
        ...
        self.assertEqual(
            tuple(
                n2f((10**6) ** 3, to="ordinal", case=c, plural=True) for c in CASES
            ),
            (
                "triljoonannet",
                "triljoonansien",
    ...
    def test_year(self):
        ...
        self.assertEqual(
            n2f(-99, to="year"), "yhdeksänkymmentäyhdeksän ennen ajanlaskun alkua"
        )

    def test_currency(self):
        self.assertEqual(n2f(150, to="currency"), "sataviisikymmentä euroa")
        self.assertEqual(
    ...
    def test_negative_decimals(self):
        ...
        self.assertEqual(
            num2words(-10.25, lang="fi"), "miinus kymmenen pilkku kaksi viisi"
        )
