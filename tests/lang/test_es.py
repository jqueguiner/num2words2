...
TEST_CASES_TO_CURRENCY_ESP = (
    (1.00, "uno peseta con cero céntimos"),
...
TEST_CASES_TO_CURRENCY_PEN = (
    (1.00, "uno sol con cero céntimos"),
...
TEST_CASES_TO_CURRENCY_GBP = (
    (1.00, "uno libra con cero peniques"),
    ...
    (4150.83, "cuatro mil ciento cincuenta libras con ochenta y tres peniques"),
)

TEST_CASES_TO_CURRENCY_RUB = (
    (1.00, "uno rublo con cero kopeykas"),
    ...
    (4150.83, "cuatro mil ciento cincuenta rublos con ochenta y tres kopeykas"),
)

TEST_CASES_TO_CURRENCY_SEK = (
    (1.00, "uno corona con cero öre"),
    ...
    (4150.83, "cuatro mil ciento cincuenta coronas con ochenta y tres öre"),
)

TEST_CASES_TO_CURRENCY_NOK = (
    (1.00, "uno corona con cero øre"),
    ...
    (4150.83, "cuatro mil ciento cincuenta coronas con ochenta y tres øre"),
)

TEST_CASES_TO_CURRENCY_PLN = (
    (1.00, "uno zloty con cero groszy"),
    ...
    (4150.83, "cuatro mil ciento cincuenta zlotys con ochenta y tres groszy"),
)

TEST_CASES_TO_CURRENCY_MXN = (
    (1.00, "uno peso con cero centavos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta pesos con ochenta y tres centavos"),
)

TEST_CASES_TO_CURRENCY_RON = (
    (1.00, "uno leu con cero bani"),
    ...
    (4150.83, "cuatro mil ciento cincuenta leus con ochenta y tres bani"),
)

TEST_CASES_TO_CURRENCY_INR = (
    (1.00, "uno rupia con cero paisas"),
    ...
    (4150.83, "cuatro mil ciento cincuenta rupias con ochenta y tres paisas"),
)

TEST_CASES_TO_CURRENCY_HUF = (
    (1.00, "uno florín con cero fillér"),
    ...
    (4150.83, "cuatro mil ciento cincuenta florines con ochenta y tres fillér"),
)

TEST_CASES_TO_CURRENCY_FRF = (
    (1.00, "uno franco con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta francos con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_CNY = (
    (1.00, "uno yuan con cero jiaos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta yuanes con ochenta y tres jiaos"),
)

TEST_CASES_TO_CURRENCY_CZK = (
    (1.00, "uno corona con cero haléř"),
    ...
    (4150.83, "cuatro mil ciento cincuenta coronas con ochenta y tres haléř"),
)

TEST_CASES_TO_CURRENCY_NIO = (
    (1.00, "uno córdoba con cero centavos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta córdobas con ochenta y tres centavos"),
)

TEST_CASES_TO_CURRENCY_VES = (
    (1.00, "uno bolívar con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta bolívares con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_BRL = (
    (1.00, "uno real con cero centavos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta reales con ochenta y tres centavos"),
)

TEST_CASES_TO_CURRENCY_JPY = (
    (1.00, "uno yen con cero sen"),
    ...
    (4150.83, "cuatro mil ciento cincuenta yenes con ochenta y tres sen"),
)

TEST_CASES_TO_CURRENCY_KRW = (
    (1.00, "uno won con cero jeon"),
    ...
    (4150.83, "cuatro mil ciento cincuenta wones con ochenta y tres jeon"),
)

TEST_CASES_TO_CURRENCY_KPW = (
    (1.00, "uno won con cero chon"),
    ...
    (4150.83, "cuatro mil ciento cincuenta wones con ochenta y tres chon"),
)

TEST_CASES_TO_CURRENCY_TRY = (
    (1.00, "uno lira con cero kuruş"),
    ...
    (4150.83, "cuatro mil ciento cincuenta liras con ochenta y tres kuruş"),
)

TEST_CASES_TO_CURRENCY_ZAR = (
    (1.00, "uno rand con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta rands con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_KZT = (
    (1.00, "uno tenge con cero tïın"),
    ...
    (4150.83, "cuatro mil ciento cincuenta tenges con ochenta y tres tïın"),
)

TEST_CASES_TO_CURRENCY_UAH = (
    (1.00, "uno hryvnia con cero kopiykas"),
    ...
    (4150.83, "cuatro mil ciento cincuenta hryvnias con ochenta y tres kopiykas"),
)

TEST_CASES_TO_CURRENCY_THB = (
    (1.00, "uno baht con cero satang"),
    ...
    (4150.83, "cuatro mil ciento cincuenta bahts con ochenta y tres satang"),
)

TEST_CASES_TO_CURRENCY_AED = (
    (1.00, "uno dirham con cero fils"),
    ...
    (4150.83, "cuatro mil ciento cincuenta dirhams con ochenta y tres fils"),
)

TEST_CASES_TO_CURRENCY_AFN = (
    (1.00, "uno afghani con cero puls"),
    ...
    (4150.83, "cuatro mil ciento cincuenta afghanis con ochenta y tres puls"),
)

TEST_CASES_TO_CURRENCY_ALL = (
    (1.00, "uno lek  con cero qindarka"),
    ...
    (4150.83, "cuatro mil ciento cincuenta leke con ochenta y tres qindarka"),
)

TEST_CASES_TO_CURRENCY_AMD = (
    (1.00, "uno dram con cero lumas"),
    ...
    (4150.83, "cuatro mil ciento cincuenta drams con ochenta y tres lumas"),
)

TEST_CASES_TO_CURRENCY_ANG = (
    (1.00, "uno florín con cero centavos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta florines con ochenta y tres centavos"),
)

TEST_CASES_TO_CURRENCY_AOA = (
    (1.00, "uno kwanza con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta kwanzas con ochenta y tres céntimos"),
)
...
TEST_CASES_TO_CURRENCY_AZN = (
    ...
    (4150.83, "cuatro mil ciento cincuenta manat con ochenta y tres qəpik"),
)

TEST_CASES_TO_CURRENCY_BDT = (
    (1.00, "uno taka con cero paisas"),
    ...
    (4150.83, "cuatro mil ciento cincuenta takas con ochenta y tres paisas"),
)

TEST_CASES_TO_CURRENCY_BGN = (
    (1.00, "uno lev con cero stotinki"),
    ...
    (4150.83, "cuatro mil ciento cincuenta leva con ochenta y tres stotinki"),
)

TEST_CASES_TO_CURRENCY_BHD = (
    (1.00, "uno dinar con cero fils"),
    ...
    (4150.83, "cuatro mil ciento cincuenta dinares con ochenta y tres fils"),
)

TEST_CASES_TO_CURRENCY_BOB = (
    (1.00, "uno boliviano con cero centavos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta bolivianos con ochenta y tres centavos"),
)

TEST_CASES_TO_CURRENCY_BTN = (
    (1.00, "uno ngultrum con cero chetrum"),
    ...
    (4150.83, "cuatro mil ciento cincuenta ngultrum con ochenta y tres chetrum"),
)

TEST_CASES_TO_CURRENCY_BWP = (
    (1.00, "uno pula con cero thebes"),
    ...
    (4150.83, "cuatro mil ciento cincuenta pulas con ochenta y tres thebes"),
)

TEST_CASES_TO_CURRENCY_BYN = (
    (1.00, "uno rublo con cero kópeks"),
    ...
    (4150.83, "cuatro mil ciento cincuenta rublos con ochenta y tres kópeks"),
)
...
TEST_CASES_TO_CURRENCY_BZD = (
    ...
    (4150.83, "cuatro mil ciento cincuenta dólares con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_CVE = (
    (1.00, "uno escudo con cero centavos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta escudos con ochenta y tres centavos"),
)

TEST_CASES_TO_CURRENCY_CYP = (
    (1.00, "uno libra con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta libras con ochenta y tres céntimos"),
)
...
TEST_CASES_TO_CURRENCY_DZD = (
    (1.00, "uno dinar con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta dinares con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_ECS = (
    (1.00, "uno sucre con cero centavos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta sucres con ochenta y tres centavos"),
)

TEST_CASES_TO_CURRENCY_EGP = (
    (1.00, "uno libra con cero piastras"),
    ...
    (4150.83, "cuatro mil ciento cincuenta libras con ochenta y tres piastras"),
)

TEST_CASES_TO_CURRENCY_ERN = (
    (1.00, "uno nakfa con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta nakfas con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_ETB = (
    (1.00, "uno birr con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta birrs con ochenta y tres céntimos"),
)
...
TEST_CASES_TO_CURRENCY_GEL = (
    ...
    (4150.83, "cuatro mil ciento cincuenta laris con ochenta y tres tetris"),
)

TEST_CASES_TO_CURRENCY_GHS = (
    (1.00, "uno cedi con cero pesewas"),
    ...
    (4150.83, "cuatro mil ciento cincuenta cedis con ochenta y tres pesewas"),
)

TEST_CASES_TO_CURRENCY_GMD = (
    (1.00, "uno dalasi con cero bututs"),
    ...
    (4150.83, "cuatro mil ciento cincuenta dalasis con ochenta y tres bututs"),
)

TEST_CASES_TO_CURRENCY_GTQ = (
    (1.00, "uno quetzal con cero centavos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta quetzales con ochenta y tres centavos"),
)

TEST_CASES_TO_CURRENCY_HNL = (
    (1.00, "uno lempira con cero centavos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta lempiras con ochenta y tres centavos"),
)

TEST_CASES_TO_CURRENCY_HRK = (
    (1.00, "uno kuna con cero lipas"),
    ...
    (4150.83, "cuatro mil ciento cincuenta kunas con ochenta y tres lipas"),
)

TEST_CASES_TO_CURRENCY_HTG = (
    (1.00, "uno gourde con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta gourdes con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_IDR = (
    (1.00, "uno rupia con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta rupias con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_ILS = (
    (1.00, "uno séquel con cero agoras"),
    ...
    (4150.83, "cuatro mil ciento cincuenta séqueles con ochenta y tres agoras"),
)
...
TEST_CASES_TO_CURRENCY_IRR = (
    (1.00, "uno rial con cero dinares"),
    ...
    (4150.83, "cuatro mil ciento cincuenta riales con ochenta y tres dinares"),
)

TEST_CASES_TO_CURRENCY_ISK = (
    (1.00, "uno corona con cero aurar"),
    ...
    (4150.83, "cuatro mil ciento cincuenta coronas con ochenta y tres aurar"),
)

TEST_CASES_TO_CURRENCY_ITL = (
    (1.00, "uno lira con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta liras con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_JOD = (
    (1.00, "uno dinar con cero piastras"),
    ...
    (4150.83, "cuatro mil ciento cincuenta dinares con ochenta y tres piastras"),
)

TEST_CASES_TO_CURRENCY_KES = (
    (1.00, "uno chelín con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta chelines con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_KGS = (
    (1.00, "uno som con cero tyiyn"),
    ...
    (4150.83, "cuatro mil ciento cincuenta som con ochenta y tres tyiyn"),
)

TEST_CASES_TO_CURRENCY_KHR = (
    (1.00, "uno riel con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta rieles con ochenta y tres céntimos"),
)
...
TEST_CASES_TO_CURRENCY_LAK = (
    ...
    (4150.83, "cuatro mil ciento cincuenta kips con ochenta y tres att"),
)
...
TEST_CASES_TO_CURRENCY_LSL = (
    (1.00, "uno loti con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta lotis con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_LTL = (
    (1.00, "uno lita con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta litas con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_LVL = (
    (1.00, "uno lat con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta lats con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_LYD = (
    (1.00, "uno dinar con cero dírhams"),
    ...
    (4150.83, "cuatro mil ciento cincuenta dinares con ochenta y tres dírhams"),
)

TEST_CASES_TO_CURRENCY_MAD = (
    (1.00, "uno dírham con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta dirhams con ochenta y tres céntimos"),
)
...
TEST_CASES_TO_CURRENCY_MDL = (
    ...
    (4150.83, "cuatro mil ciento cincuenta lei con ochenta y tres bani"),
)

TEST_CASES_TO_CURRENCY_MGA = (
    (1.00, "uno ariary con cero iraimbilanja"),
    ...
    (4150.83, "cuatro mil ciento cincuenta ariaris con ochenta y tres iraimbilanja"),
)

TEST_CASES_TO_CURRENCY_MKD = (
    (1.00, "uno denar con cero denis"),
    ...
    (4150.83, "cuatro mil ciento cincuenta denares con ochenta y tres denis"),
)

TEST_CASES_TO_CURRENCY_MMK = (
    (1.00, "uno kiat con cero pyas"),
    ...
    (4150.83, "cuatro mil ciento cincuenta kiats con ochenta y tres pyas"),
)

TEST_CASES_TO_CURRENCY_MNT = (
    (1.00, "uno tugrik con cero möngö"),
    ...
    (4150.83, "cuatro mil ciento cincuenta tugriks con ochenta y tres möngö"),
)

TEST_CASES_TO_CURRENCY_MOP = (
    (1.00, "uno pataca con cero avos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta patacas con ochenta y tres avos"),
)

TEST_CASES_TO_CURRENCY_MRO = (
    (1.00, "uno ouguiya con cero khoums"),
    ...
    (4150.83, "cuatro mil ciento cincuenta ouguiyas con ochenta y tres khoums"),
)
...
TEST_CASES_TO_CURRENCY_MVR = (
    (1.00, "uno rufiyaa con cero laari"),
    ...
    (4150.83, "cuatro mil ciento cincuenta rufiyaas con ochenta y tres laari"),
)

TEST_CASES_TO_CURRENCY_MWK = (
    (1.00, "uno kuacha con cero tambalas"),
    ...
    (4150.83, "cuatro mil ciento cincuenta kuachas con ochenta y tres tambalas"),
)

TEST_CASES_TO_CURRENCY_MYR = (
    (1.00, "uno ringgit con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta ringgit con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_MZN = (
    (1.00, "uno metical con cero centavos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta metical con ochenta y tres centavos"),
)

TEST_CASES_TO_CURRENCY_NGN = (
    (1.00, "uno naira con cero kobo"),
    ...
    (4150.83, "cuatro mil ciento cincuenta nairas con ochenta y tres kobo"),
)
...
TEST_CASES_TO_CURRENCY_OMR = (
    ...
    (4150.83, "cuatro mil ciento cincuenta riales con ochenta y tres baisa"),
)

TEST_CASES_TO_CURRENCY_PAB = (
    (1.00, "uno balboa con cero centésimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta balboas con ochenta y tres centésimos"),
)

TEST_CASES_TO_CURRENCY_PGK = (
    (1.00, "uno kina con cero toea"),
    ...
    (4150.83, "cuatro mil ciento cincuenta kinas con ochenta y tres toea"),
)
...
TEST_CASES_TO_CURRENCY_PYG = (
    (1.00, "uno guaraní con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta guaranís con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_QAR = (
    (1.00, "uno rial con cero dírhams"),
    ...
    (4150.83, "cuatro mil ciento cincuenta riales con ochenta y tres dírhams"),
)

TEST_CASES_TO_CURRENCY_RSD = (
    (1.00, "uno dinar con cero para"),
    ...
    (4150.83, "cuatro mil ciento cincuenta dinares con ochenta y tres para"),
)

TEST_CASES_TO_CURRENCY_RUR = (
    (1.00, "uno rublo con cero kopeks"),
    ...
    (4150.83, "cuatro mil ciento cincuenta rublos con ochenta y tres kopeks"),
)

TEST_CASES_TO_CURRENCY_SAR = (
    (1.00, "uno riyal con cero halalas"),
    ...
    (4150.83, "cuatro mil ciento cincuenta riales con ochenta y tres halalas"),
)
...
TEST_CASES_TO_CURRENCY_SKK = (
    (1.00, "uno corona con cero haliers"),
    ...
    (4150.83, "cuatro mil ciento cincuenta coronas con ochenta y tres haliers"),
)

TEST_CASES_TO_CURRENCY_SLL = (
    (1.00, "uno leona con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta leonas con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_STD = (
    (1.00, "uno dobra con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta dobras con ochenta y tres céntimos"),
)
...
TEST_CASES_TO_CURRENCY_SZL = (
    (1.00, "uno lilangeni con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta emalangeni con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_TJS = (
    (1.00, "uno somoni con cero dirames"),
    ...
    (4150.83, "cuatro mil ciento cincuenta somonis con ochenta y tres dirames"),
)

TEST_CASES_TO_CURRENCY_TMT = (
    (1.00, "uno manat con cero tenge"),
    ...
    (4150.83, "cuatro mil ciento cincuenta manat con ochenta y tres tenge"),
)

TEST_CASES_TO_CURRENCY_TND = (
    (1.00, "uno dinar con cero milésimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta dinares con ochenta y tres milésimos"),
)

TEST_CASES_TO_CURRENCY_TOP = (
    (1.00, "uno paanga con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta paangas con ochenta y tres céntimos"),
)

wordamount = "{} {}".format(
    "cuatro mil ciento cincuenta", "nuevos dólares con ochenta y tres céntimos"
)

TEST_CASES_TO_CURRENCY_TWD = (
    (1.00, "uno nuevo dólar con cero céntimos"),
...
TEST_CASES_TO_CURRENCY_UYU = (
    (1.00, "uno peso con cero centésimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta pesos con ochenta y tres centésimos"),
)

TEST_CASES_TO_CURRENCY_UZS = (
    (1.00, "uno sum con cero tiyin"),
    ...
    (4150.83, "cuatro mil ciento cincuenta sum con ochenta y tres tiyin"),
)

wordamount = "{} {}".format(
    "cuatro mil ciento cincuenta", "bolívares fuertes con ochenta y tres céntimos"
)

TEST_CASES_TO_CURRENCY_VEF = (
    (1.00, "uno bolívar fuerte con cero céntimos"),
...
TEST_CASES_TO_CURRENCY_VND = (
    ...
    (4150.83, "cuatro mil ciento cincuenta dongs con ochenta y tres xu"),
)

TEST_CASES_TO_CURRENCY_VUV = (
    (1.00, "uno vatu con cero nenhum"),
    ...
    (4150.83, "cuatro mil ciento cincuenta vatu con ochenta y tres nenhum"),
)

TEST_CASES_TO_CURRENCY_WST = (
    (1.00, "uno tala con cero centavos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta tala con ochenta y tres centavos"),
)

TEST_CASES_TO_CURRENCY_XAF = (
    (1.00, "uno franco CFA con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta francos CFA con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_XPF = (
    (1.00, "uno franco CFP con cero céntimos"),
    ...
    (4150.83, "cuatro mil ciento cincuenta francos CFP con ochenta y tres céntimos"),
)

TEST_CASES_TO_CURRENCY_YER = (
    (1.00, "uno rial con cero fils"),
    ...
    (4150.83, "cuatro mil ciento cincuenta riales con ochenta y tres fils"),
)
...
TEST_CASES_TO_CURRENCY_ZMW = (
    (1.00, "uno kwacha con cero ngwee"),
    ...
    (4150.83, "cuatro mil ciento cincuenta kwachas con ochenta y tres ngwee"),
)

TEST_CASES_TO_CURRENCY_ZRZ = (
    (1.00, "uno zaire con cero makuta"),
    ...
    (4150.83, "cuatro mil ciento cincuenta zaires con ochenta y tres makuta"),
)
...
class Num2WordsESTest(TestCase):
    ...
    def test_ordinal_fem(self):
        for test in TEST_CASES_ORDINAL_FEM:
            self.assertEqual(
                num2words(test[0], lang="es", ordinal=True, gender="f"), test[1]
            )

    def test_ordinal_num(self):
        for test in TEST_CASES_ORDINAL_NUM:
            self.assertEqual(num2words(test[0], lang="es", to="ordinal_num"), test[1])

    def test_currency(self):
        for test in TEST_CASES_TO_CURRENCY:
            self.assertEqual(num2words(test[0], lang="es", to="currency"), test[1])

    def test_currency_esp(self):
        for test in TEST_CASES_TO_CURRENCY_ESP:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="ESP"), test[1]
            )

    def test_currency_usd(self):
        for test in TEST_CASES_TO_CURRENCY_USD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="USD"), test[1]
            )
    ...
    def test_currency_crc(self):
        for test in TEST_CASES_TO_CURRENCY_CRC:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="CRC"), test[1]
            )

    def test_currency_aud(self):
        for test in TEST_CASES_TO_CURRENCY_USD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="AUD"), test[1]
            )

    def test_currency_cad(self):
        for test in TEST_CASES_TO_CURRENCY_USD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="CAD"), test[1]
            )

    def test_currency_gbp(self):
        for test in TEST_CASES_TO_CURRENCY_GBP:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="GBP"), test[1]
            )

    def test_currency_rub(self):
        for test in TEST_CASES_TO_CURRENCY_RUB:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="RUB"), test[1]
            )

    def test_currency_sek(self):
        for test in TEST_CASES_TO_CURRENCY_SEK:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="SEK"), test[1]
            )

    def test_currency_nok(self):
        for test in TEST_CASES_TO_CURRENCY_NOK:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="NOK"), test[1]
            )

    def test_currency_pln(self):
        for test in TEST_CASES_TO_CURRENCY_PLN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="PLN"), test[1]
            )

    def test_currency_mxn(self):
        for test in TEST_CASES_TO_CURRENCY_MXN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="MXN"), test[1]
            )

    def test_currency_ron(self):
        for test in TEST_CASES_TO_CURRENCY_RON:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="RON"), test[1]
            )

    def test_currency_inr(self):
        for test in TEST_CASES_TO_CURRENCY_INR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="INR"), test[1]
            )

    def test_currency_huf(self):
        for test in TEST_CASES_TO_CURRENCY_HUF:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="HUF"), test[1]
            )

    def test_currency_frf(self):
        for test in TEST_CASES_TO_CURRENCY_FRF:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="FRF"), test[1]
            )

    def test_currency_cny(self):
        for test in TEST_CASES_TO_CURRENCY_CNY:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="CNY"), test[1]
            )

    def test_currency_czk(self):
        for test in TEST_CASES_TO_CURRENCY_CZK:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="CZK"), test[1]
            )

    def test_currency_nio(self):
        for test in TEST_CASES_TO_CURRENCY_NIO:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="NIO"), test[1]
            )

    def test_currency_ves(self):
        for test in TEST_CASES_TO_CURRENCY_VES:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="VES"), test[1]
            )

    def test_currency_brl(self):
        for test in TEST_CASES_TO_CURRENCY_BRL:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="BRL"), test[1]
            )

    def test_currency_chf(self):
        for test in TEST_CASES_TO_CURRENCY_FRF:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="CHF"), test[1]
            )

    def test_currency_jpy(self):
        for test in TEST_CASES_TO_CURRENCY_JPY:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="JPY"), test[1]
            )

    def test_currency_krw(self):
        for test in TEST_CASES_TO_CURRENCY_KRW:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="KRW"), test[1]
            )

    def test_currency_kpw(self):
        for test in TEST_CASES_TO_CURRENCY_KPW:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="KPW"), test[1]
            )

    def test_currency_try(self):
        for test in TEST_CASES_TO_CURRENCY_TRY:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="TRY"), test[1]
            )

    def test_currency_zar(self):
        for test in TEST_CASES_TO_CURRENCY_ZAR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="ZAR"), test[1]
            )

    def test_currency_kzt(self):
        for test in TEST_CASES_TO_CURRENCY_KZT:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="KZT"), test[1]
            )

    def test_currency_uah(self):
        for test in TEST_CASES_TO_CURRENCY_UAH:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="UAH"), test[1]
            )

    def test_currency_thb(self):
        for test in TEST_CASES_TO_CURRENCY_THB:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="THB"), test[1]
            )

    def test_currency_aed(self):
        for test in TEST_CASES_TO_CURRENCY_AED:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="AED"), test[1]
            )

    def test_currency_afn(self):
        for test in TEST_CASES_TO_CURRENCY_AFN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="AFN"), test[1]
            )

    def test_currency_all(self):
        for test in TEST_CASES_TO_CURRENCY_ALL:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="ALL"), test[1]
            )

    def test_currency_amd(self):
        for test in TEST_CASES_TO_CURRENCY_AMD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="AMD"), test[1]
            )

    def test_currency_ang(self):
        for test in TEST_CASES_TO_CURRENCY_ANG:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="ANG"), test[1]
            )

    def test_currency_aoa(self):
        for test in TEST_CASES_TO_CURRENCY_AOA:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="AOA"), test[1]
            )

    def test_currency_ars(self):
        for test in TEST_CASES_TO_CURRENCY_MXN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="ARS"), test[1]
            )

    def test_currency_awg(self):
        for test in TEST_CASES_TO_CURRENCY_AWG:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="AWG"), test[1]
            )

    def test_currency_azn(self):
        for test in TEST_CASES_TO_CURRENCY_AZN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="AZN"), test[1]
            )

    def test_currency_bbd(self):
        for test in TEST_CASES_TO_CURRENCY_USD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="BBD"), test[1]
            )

    def test_currency_bdt(self):
        for test in TEST_CASES_TO_CURRENCY_BDT:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="BDT"), test[1]
            )

    def test_currency_bgn(self):
        for test in TEST_CASES_TO_CURRENCY_BGN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="BGN"), test[1]
            )

    def test_currency_bhd(self):
        for test in TEST_CASES_TO_CURRENCY_BHD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="BHD"), test[1]
            )

    def test_currency_bif(self):
        for test in TEST_CASES_TO_CURRENCY_FRF:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="BIF"), test[1]
            )

    def test_currency_bmd(self):
        for test in TEST_CASES_TO_CURRENCY_USD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="BMD"), test[1]
            )

    def test_currency_bnd(self):
        for test in TEST_CASES_TO_CURRENCY_USD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="BND"), test[1]
            )

    def test_currency_bob(self):
        for test in TEST_CASES_TO_CURRENCY_BOB:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="BOB"), test[1]
            )

    def test_currency_bsd(self):
        for test in TEST_CASES_TO_CURRENCY_USD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="BSD"), test[1]
            )

    def test_currency_btn(self):
        for test in TEST_CASES_TO_CURRENCY_BTN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="BTN"), test[1]
            )

    def test_currency_bwp(self):
        for test in TEST_CASES_TO_CURRENCY_BWP:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="BWP"), test[1]
            )

    def test_currency_byn(self):
        for test in TEST_CASES_TO_CURRENCY_BYN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="BYN"), test[1]
            )

    def test_currency_byr(self):
        for test in TEST_CASES_TO_CURRENCY_BYR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="BYR"), test[1]
            )

    def test_currency_bzd(self):
        for test in TEST_CASES_TO_CURRENCY_BZD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="BZD"), test[1]
            )

    def test_currency_cdf(self):
        for test in TEST_CASES_TO_CURRENCY_FRF:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="CDF"), test[1]
            )

    def test_currency_clp(self):
        for test in TEST_CASES_TO_CURRENCY_MXN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="CLP"), test[1]
            )

    def test_currency_cop(self):
        for test in TEST_CASES_TO_CURRENCY_MXN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="COP"), test[1]
            )

    def test_currency_cup(self):
        for test in TEST_CASES_TO_CURRENCY_MXN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="CUP"), test[1]
            )

    def test_currency_cve(self):
        for test in TEST_CASES_TO_CURRENCY_CVE:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="CVE"), test[1]
            )

    def test_currency_cyp(self):
        for test in TEST_CASES_TO_CURRENCY_CYP:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="CYP"), test[1]
            )

    def test_currency_djf(self):
        for test in TEST_CASES_TO_CURRENCY_FRF:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="DJF"), test[1]
            )

    def test_currency_dkk(self):
        for test in TEST_CASES_TO_CURRENCY_DKK:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="DKK"), test[1]
            )

    def test_currency_dop(self):
        for test in TEST_CASES_TO_CURRENCY_MXN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="DOP"), test[1]
            )

    def test_currency_dzd(self):
        for test in TEST_CASES_TO_CURRENCY_DZD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="DZD"), test[1]
            )

    def test_currency_ecs(self):
        for test in TEST_CASES_TO_CURRENCY_ECS:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="ECS"), test[1]
            )

    def test_currency_egp(self):
        for test in TEST_CASES_TO_CURRENCY_EGP:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="EGP"), test[1]
            )

    def test_currency_ern(self):
        for test in TEST_CASES_TO_CURRENCY_ERN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="ERN"), test[1]
            )

    def test_currency_etb(self):
        for test in TEST_CASES_TO_CURRENCY_ETB:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="ETB"), test[1]
            )

    def test_currency_fjd(self):
        for test in TEST_CASES_TO_CURRENCY_USD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="FJD"), test[1]
            )

    def test_currency_fkp(self):
        for test in TEST_CASES_TO_CURRENCY_FKP:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="FKP"), test[1]
            )

    def test_currency_gel(self):
        for test in TEST_CASES_TO_CURRENCY_GEL:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="GEL"), test[1]
            )

    def test_currency_ghs(self):
        for test in TEST_CASES_TO_CURRENCY_GHS:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="GHS"), test[1]
            )

    def test_currency_gip(self):
        for test in TEST_CASES_TO_CURRENCY_FKP:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="GIP"), test[1]
            )

    def test_currency_gmd(self):
        for test in TEST_CASES_TO_CURRENCY_GMD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="GMD"), test[1]
            )

    def test_currency_gnf(self):
        for test in TEST_CASES_TO_CURRENCY_FRF:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="GNF"), test[1]
            )

    def test_currency_gtq(self):
        for test in TEST_CASES_TO_CURRENCY_GTQ:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="GTQ"), test[1]
            )

    def test_currency_gyd(self):
        for test in TEST_CASES_TO_CURRENCY_USD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="GYD"), test[1]
            )

    def test_currency_hkd(self):
        for test in TEST_CASES_TO_CURRENCY_USD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="HKD"), test[1]
            )

    def test_currency_hnl(self):
        for test in TEST_CASES_TO_CURRENCY_HNL:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="HNL"), test[1]
            )

    def test_currency_hrk(self):
        for test in TEST_CASES_TO_CURRENCY_HRK:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="HRK"), test[1]
            )

    def test_currency_htg(self):
        for test in TEST_CASES_TO_CURRENCY_HTG:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="HTG"), test[1]
            )

    def test_currency_idr(self):
        for test in TEST_CASES_TO_CURRENCY_IDR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="IDR"), test[1]
            )

    def test_currency_ils(self):
        for test in TEST_CASES_TO_CURRENCY_ILS:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="ILS"), test[1]
            )

    def test_currency_iqd(self):
        for test in TEST_CASES_TO_CURRENCY_IQD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="IQD"), test[1]
            )

    def test_currency_irr(self):
        for test in TEST_CASES_TO_CURRENCY_IRR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="IRR"), test[1]
            )

    def test_currency_isk(self):
        for test in TEST_CASES_TO_CURRENCY_ISK:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="ISK"), test[1]
            )

    def test_currency_itl(self):
        for test in TEST_CASES_TO_CURRENCY_ITL:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="ITL"), test[1]
            )

    def test_currency_jmd(self):
        for test in TEST_CASES_TO_CURRENCY_BZD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="JMD"), test[1]
            )

    def test_currency_jod(self):
        for test in TEST_CASES_TO_CURRENCY_JOD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="JOD"), test[1]
            )

    def test_currency_kes(self):
        for test in TEST_CASES_TO_CURRENCY_KES:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="KES"), test[1]
            )

    def test_currency_kgs(self):
        for test in TEST_CASES_TO_CURRENCY_KGS:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="KGS"), test[1]
            )

    def test_currency_khr(self):
        for test in TEST_CASES_TO_CURRENCY_KHR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="KHR"), test[1]
            )

    def test_currency_kmf(self):
        for test in TEST_CASES_TO_CURRENCY_FRF:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="KMF"), test[1]
            )

    def test_currency_kwd(self):
        for test in TEST_CASES_TO_CURRENCY_KWD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="KWD"), test[1]
            )

    def test_currency_kyd(self):
        for test in TEST_CASES_TO_CURRENCY_BZD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="KYD"), test[1]
            )

    def test_currency_lak(self):
        for test in TEST_CASES_TO_CURRENCY_LAK:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="LAK"), test[1]
            )

    def test_currency_lbp(self):
        for test in TEST_CASES_TO_CURRENCY_EGP:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="LBP"), test[1]
            )

    def test_currency_lkr(self):
        for test in TEST_CASES_TO_CURRENCY_LKR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="LKR"), test[1]
            )

    def test_currency_lrd(self):
        for test in TEST_CASES_TO_CURRENCY_BZD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="LRD"), test[1]
            )

    def test_currency_lsl(self):
        for test in TEST_CASES_TO_CURRENCY_LSL:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="LSL"), test[1]
            )

    def test_currency_ltl(self):
        for test in TEST_CASES_TO_CURRENCY_LTL:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="LTL"), test[1]
            )

    def test_currency_lvl(self):
        for test in TEST_CASES_TO_CURRENCY_LVL:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="LVL"), test[1]
            )

    def test_currency_lyd(self):
        for test in TEST_CASES_TO_CURRENCY_LYD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="LYD"), test[1]
            )

    def test_currency_mad(self):
        for test in TEST_CASES_TO_CURRENCY_MAD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="MAD"), test[1]
            )

    def test_currency_mdl(self):
        for test in TEST_CASES_TO_CURRENCY_MDL:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="MDL"), test[1]
            )

    def test_currency_mga(self):
        for test in TEST_CASES_TO_CURRENCY_MGA:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="MGA"), test[1]
            )

    def test_currency_mkd(self):
        for test in TEST_CASES_TO_CURRENCY_MKD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="MKD"), test[1]
            )

    def test_currency_mmk(self):
        for test in TEST_CASES_TO_CURRENCY_MMK:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="MMK"), test[1]
            )

    def test_currency_mnt(self):
        for test in TEST_CASES_TO_CURRENCY_MNT:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="MNT"), test[1]
            )

    def test_currency_mop(self):
        for test in TEST_CASES_TO_CURRENCY_MOP:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="MOP"), test[1]
            )

    def test_currency_mro(self):
        for test in TEST_CASES_TO_CURRENCY_MRO:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="MRO"), test[1]
            )

    def test_currency_mru(self):
        for test in TEST_CASES_TO_CURRENCY_MRU:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="MRU"), test[1]
            )

    def test_currency_mur(self):
        for test in TEST_CASES_TO_CURRENCY_MUR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="MUR"), test[1]
            )

    def test_currency_mvr(self):
        for test in TEST_CASES_TO_CURRENCY_MVR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="MVR"), test[1]
            )

    def test_currency_mwk(self):
        for test in TEST_CASES_TO_CURRENCY_MWK:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="MWK"), test[1]
            )

    def test_currency_myr(self):
        for test in TEST_CASES_TO_CURRENCY_MYR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="MYR"), test[1]
            )

    def test_currency_mzn(self):
        for test in TEST_CASES_TO_CURRENCY_MZN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="MZN"), test[1]
            )

    def test_currency_nad(self):
        for test in TEST_CASES_TO_CURRENCY_BZD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="NAD"), test[1]
            )

    def test_currency_ngn(self):
        for test in TEST_CASES_TO_CURRENCY_NGN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="NGN"), test[1]
            )

    def test_currency_npr(self):
        for test in TEST_CASES_TO_CURRENCY_NPR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="NPR"), test[1]
            )

    def test_currency_nzd(self):
        for test in TEST_CASES_TO_CURRENCY_USD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="NZD"), test[1]
            )

    def test_currency_omr(self):
        for test in TEST_CASES_TO_CURRENCY_OMR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="OMR"), test[1]
            )

    def test_currency_pab(self):
        for test in TEST_CASES_TO_CURRENCY_PAB:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="PAB"), test[1]
            )

    def test_currency_pgk(self):
        for test in TEST_CASES_TO_CURRENCY_PGK:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="PGK"), test[1]
            )

    def test_currency_php(self):
        for test in TEST_CASES_TO_CURRENCY_MXN:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="PHP"), test[1]
            )

    def test_currency_pkr(self):
        for test in TEST_CASES_TO_CURRENCY_PKR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="PKR"), test[1]
            )

    def test_currency_plz(self):
        for test in TEST_CASES_TO_CURRENCY_PLZ:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="PLZ"), test[1]
            )

    def test_currency_pyg(self):
        for test in TEST_CASES_TO_CURRENCY_PYG:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="PYG"), test[1]
            )

    def test_currency_qar(self):
        for test in TEST_CASES_TO_CURRENCY_QAR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="QAR"), test[1]
            )
    ...
    def test_currency_rsd(self):
        for test in TEST_CASES_TO_CURRENCY_RSD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="RSD"), test[1]
            )

    def test_currency_rur(self):
        for test in TEST_CASES_TO_CURRENCY_RUR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="RUR"), test[1]
            )

    def test_currency_rwf(self):
        for test in TEST_CASES_TO_CURRENCY_FRF:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="RWF"), test[1]
            )

    def test_currency_sar(self):
        for test in TEST_CASES_TO_CURRENCY_SAR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="SAR"), test[1]
            )

    def test_currency_sbd(self):
        for test in TEST_CASES_TO_CURRENCY_BZD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="SBD"), test[1]
            )

    def test_currency_scr(self):
        for test in TEST_CASES_TO_CURRENCY_SCR:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="SCR"), test[1]
            )

    def test_currency_sdg(self):
        for test in TEST_CASES_TO_CURRENCY_EGP:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="SDG"), test[1]
            )

    def test_currency_sgd(self):
        for test in TEST_CASES_TO_CURRENCY_BZD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="SGD"), test[1]
            )

    def test_currency_shp(self):
        for test in TEST_CASES_TO_CURRENCY_SHP:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="SHP"), test[1]
            )

    def test_currency_skk(self):
        for test in TEST_CASES_TO_CURRENCY_SKK:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="SKK"), test[1]
            )

    def test_currency_sll(self):
        for test in TEST_CASES_TO_CURRENCY_SLL:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="SLL"), test[1]
            )

    def test_currency_srd(self):
        for test in TEST_CASES_TO_CURRENCY_BZD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="SRD"), test[1]
            )

    def test_currency_ssp(self):
        for test in TEST_CASES_TO_CURRENCY_EGP:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="SSP"), test[1]
            )

    def test_currency_std(self):
        for test in TEST_CASES_TO_CURRENCY_STD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="STD"), test[1]
            )

    def test_currency_svc(self):
        for test in TEST_CASES_TO_CURRENCY_SVC:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="SVC"), test[1]
            )

    def test_currency_syp(self):
        for test in TEST_CASES_TO_CURRENCY_EGP:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="SYP"), test[1]
            )

    def test_currency_szl(self):
        for test in TEST_CASES_TO_CURRENCY_SZL:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="SZL"), test[1]
            )

    def test_currency_tjs(self):
        for test in TEST_CASES_TO_CURRENCY_TJS:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="TJS"), test[1]
            )

    def test_currency_tmt(self):
        for test in TEST_CASES_TO_CURRENCY_TMT:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="TMT"), test[1]
            )

    def test_currency_tnd(self):
        for test in TEST_CASES_TO_CURRENCY_TND:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="TND"), test[1]
            )

    def test_currency_top(self):
        for test in TEST_CASES_TO_CURRENCY_TOP:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="TOP"), test[1]
            )

    def test_currency_ttd(self):
        for test in TEST_CASES_TO_CURRENCY_BZD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="TTD"), test[1]
            )

    def test_currency_twd(self):
        for test in TEST_CASES_TO_CURRENCY_TWD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="TWD"), test[1]
            )

    def test_currency_tzs(self):
        for test in TEST_CASES_TO_CURRENCY_TZS:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="TZS"), test[1]
            )

    def test_currency_uag(self):
        for test in TEST_CASES_TO_CURRENCY_UAG:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="UAG"), test[1]
            )

    def test_currency_ugx(self):
        for test in TEST_CASES_TO_CURRENCY_UGX:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="UGX"), test[1]
            )

    def test_currency_uyu(self):
        for test in TEST_CASES_TO_CURRENCY_UYU:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="UYU"), test[1]
            )

    def test_currency_uzs(self):
        for test in TEST_CASES_TO_CURRENCY_UZS:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="UZS"), test[1]
            )

    def test_currency_vef(self):
        for test in TEST_CASES_TO_CURRENCY_VEF:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="VEF"), test[1]
            )

    def test_currency_vnd(self):
        for test in TEST_CASES_TO_CURRENCY_VND:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="VND"), test[1]
            )

    def test_currency_vuv(self):
        for test in TEST_CASES_TO_CURRENCY_VUV:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="VUV"), test[1]
            )

    def test_currency_wst(self):
        for test in TEST_CASES_TO_CURRENCY_WST:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="WST"), test[1]
            )

    def test_currency_xaf(self):
        for test in TEST_CASES_TO_CURRENCY_XAF:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="XAF"), test[1]
            )

    def test_currency_xcd(self):
        for test in TEST_CASES_TO_CURRENCY_BZD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="XCD"), test[1]
            )

    def test_currency_xof(self):
        for test in TEST_CASES_TO_CURRENCY_XAF:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="XOF"), test[1]
            )

    def test_currency_xpf(self):
        for test in TEST_CASES_TO_CURRENCY_XPF:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="XPF"), test[1]
            )

    def test_currency_yer(self):
        for test in TEST_CASES_TO_CURRENCY_YER:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="YER"), test[1]
            )

    def test_currency_yum(self):
        for test in TEST_CASES_TO_CURRENCY_YUM:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="YUM"), test[1]
            )

    def test_currency_zmw(self):
        for test in TEST_CASES_TO_CURRENCY_ZMW:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="ZMW"), test[1]
            )

    def test_currency_zrz(self):
        for test in TEST_CASES_TO_CURRENCY_ZRZ:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="ZRZ"), test[1]
            )

    def test_currency_zwl(self):
        for test in TEST_CASES_TO_CURRENCY_BZD:
            self.assertEqual(
                num2words(test[0], lang="es", to="currency", currency="ZWL"), test[1]
            )
