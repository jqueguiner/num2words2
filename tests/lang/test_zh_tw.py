...
class Num2WordsZhTWTest(TestCase):
    ...
    def test_high(self):
        ...
        self.assertEqual(n2zh_tw(12345, reading=True), "ㄧㄨㄢˋ" "ㄦˋㄑㄧㄢ" "ㄙㄢㄅㄞˇ" "ㄙˋㄕˊㄨˇ")
        ...
        self.assertEqual(
            n2zh_tw(5 * 10**8 + 80 * 10**4, reading=True),
            "ㄨˇㄧˋ" "ㄌㄧㄥˊ" "ㄅㄚㄕˊㄨㄢˋ",
        )
        ...
        self.assertEqual(
            n2zh_tw(123456789, reading=True),
            "ㄧㄧˋ" "ㄦˋㄑㄧㄢ" "ㄙㄢㄅㄞˇㄙˋㄕˊㄨˇㄨㄢˋ" "ㄌㄧㄡˋㄑㄧㄢ" "ㄑㄧㄅㄞˇ" "ㄅㄚㄕˊ" "ㄐㄧㄡˇ",
        )
        self.assertEqual(n2zh_tw(4080 * 10**8), "四千零八十億")
        self.assertEqual(n2zh_tw(4080 * 10**8, reading=True), "ㄙˋㄑㄧㄢ" "ㄌㄧㄥˊ" "ㄅㄚㄕˊㄧˋ")
    ...
    def test_cardinal_float(self):
        ...
        self.assertEqual(
            n2zh_tw(0.0123456789, reading=True),
            "ㄌㄧㄥˊ" "ㄉㄧㄢˇ" "ㄌㄧㄥˊ" "ㄧㄦˋㄙㄢㄙˋㄨˇㄌㄧㄡˋㄑㄧㄅㄚㄐㄧㄡˇ",
        )
        self.assertEqual(n2zh_tw(-0.0123456789), "負零點零一二三四五六七八九")
        self.assertEqual(
            n2zh_tw(-0.0123456789, reading=True),
            "ㄈㄨˋ" "ㄌㄧㄥˊ" "ㄉㄧㄢˇ" "ㄌㄧㄥˊ" "ㄧㄦˋㄙㄢㄙˋㄨˇㄌㄧㄡˋㄑㄧㄅㄚㄐㄧㄡˇ",
        )
        self.assertEqual(n2zh_tw(10**8 + 0.01), "一億點零一")
        self.assertEqual(n2zh_tw(10**8 + 0.01, reading=True), "ㄧㄧˋㄉㄧㄢˇㄌㄧㄥˊㄧ")

    def test_ordinal(self):
        self.assertEqual(n2zh_tw(0, to="ordinal"), "第零")
        self.assertEqual(n2zh_tw(0, to="ordinal", reading=True), "ㄉㄧˋㄌㄧㄥˊ")
        self.assertEqual(
            n2zh_tw(0, to="ordinal", counter="個", reading=True), "ㄉㄧˋㄌㄧㄥˊ˙ㄍㄜ"
        )
    ...
    def test_ordinal_num(self):
        ...
        self.assertEqual(
            n2zh_tw(0, to="ordinal_num", counter="個", reading=True), "ㄉㄧˋ0˙ㄍㄜ"
        )
        with self.assertRaises(NotImplementedError):
