...
class Num2WordsITTest(TestCase):
    ...
    def test_float_to_cardinal(self):
        ...
        self.assertEqual(num2words(-5.15, lang="it"), "meno cinque virgola uno cinque")
    ...
    def test_nth_1_to_99(self):
        ...
        self.assertEqual(num2words(21, lang="it", ordinal=True), "ventunesimo")
    ...
    def test_nth_100_to_999(self):
        ...
        self.assertEqual(num2words(121, lang="it", ordinal=True), "centoventunesimo")
    ...
    def test_nth_1000_to_999999(self):
        ...
        self.assertEqual(
            num2words(8640, lang="it", ordinal=True), "ottomilaseicentoquarantesimo"
        )
        self.assertEqual(
    ...
    def test_nth_big(self):
        self.assertEqual(
            num2words(1000000001, lang="it", ordinal=True), "un miliardo e unesimo"
        )
        self.assertEqual(
    ...
    def test_with_floats(self):
        self.assertEqual(num2words(1.0, lang="it"), "uno")
        self.assertEqual(num2words(1.1, lang="it"), "uno virgola uno")
    ...
    def test_with_strings(self):
        ...
        self.assertEqual(num2words("100", lang="it", to="ordinal"), "centesimo")
        self.assertEqual(num2words("1000", lang="it", to="ordinal"), "millesimo")
        self.assertEqual(
    ...
    def test_currency_eur(self):
        for test in TEST_CASES_TO_CURRENCY_EUR:
            self.assertEqual(
                num2words(test[0], lang="it", to="currency", currency="EUR"), test[1]
            )

    def test_currency_usd(self):
        for test in TEST_CASES_TO_CURRENCY_USD:
            self.assertEqual(
                num2words(test[0], lang="it", to="currency", currency="USD"), test[1]
            )

    def test_currency_gbp(self):
        for test in TEST_CASES_TO_CURRENCY_GBP:
            self.assertEqual(
                num2words(test[0], lang="it", to="currency", currency="GBP"), test[1]
            )
