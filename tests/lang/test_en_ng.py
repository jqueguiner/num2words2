...
class Num2WordsENNGTest(TestCase):
    ...
    def test_to_currency(self):
        ...
        self.assertEqual(
            num2words(
                "38.4", lang=language, to="currency", separator=separator, kobo=False
            ),
            "thirty-eight naira and 40 kobo",
        )
        self.assertEqual(
            num2words(
                "0", lang=language, to="currency", separator=separator, kobo=False
            ),
            "zero naira",
        )
        ...
        self.assertEqual(
            num2words(
                "1.01", lang=language, to="currency", separator=separator, kobo=True
            ),
        ...
        self.assertEqual(
            num2words(
                "4778.00", lang=language, to="currency", separator=separator, kobo=True
            ),
            "four thousand, seven hundred and seventy-eight naira and" " zero kobo",
        )

        self.assertEqual(
            num2words(
                "1.1", lang=language, to="currency", separator=separator, kobo=True
            ),
        ...
        self.assertEqual(
            num2words(
                "158.3", lang=language, to="currency", separator=separator, kobo=True
            ),
        ...
        self.assertEqual(
            num2words(
                "4.01", lang=language, to="currency", separator=separator, kobo=True
            ),
