...
class Num2WordsZHTest(TestCase):
    ...
    def test_high(self):
        ...
        self.assertEqual(
            n2zh_cn(1234567890, reading="capital"),
            "壹拾贰亿叁仟肆佰伍拾陆万柒仟捌佰玖拾",
        )
        self.assertEqual(
    ...
    @pytest.mark.xfail(strict=False, reason="Chinese (zh_cn) currency not implemented in the Rust port")
    def test_currency(self):
        self.assertEqual(n2zh_cn("0", to="currency", reading="capital"), "零圆正")
        self.assertEqual(n2zh_cn(5.00, to="currency", reading="capital"), "伍圆正")
        self.assertEqual(n2zh_cn("0", to="currency"), "零元")
        self.assertEqual(n2zh_cn(5.00, to="currency"), "五元")
        self.assertEqual(n2zh_cn(10.05, to="currency", reading="capital"), "壹拾圆伍分")
        self.assertEqual(n2zh_cn(10.05, to="currency"), "十元零五分")
        self.assertEqual(n2zh_cn(12.12, to="currency", reading="capital"), "壹拾贰圆壹角贰分")
        self.assertEqual(
            n2zh_cn(1235678, to="currency", reading="capital"),
            "壹佰贰拾叁万伍仟陆佰柒拾捌圆正",
        )
        self.assertEqual(
            n2zh_cn("1234567890.123", to="currency", reading="capital"),
            "壹拾贰亿叁仟肆佰伍拾陆万柒仟捌佰玖拾圆壹角贰分",
        )
        self.assertEqual(n2zh_cn(67890.126, to="currency"), "六万七千八百九十元一角三分")
        self.assertEqual(
            n2zh_cn(987654.3, to="currency", currency="USD", reading="capital"),
            "美元玖拾捌万柒仟陆佰伍拾肆圆叁角",
        )
        self.assertEqual(
            n2zh_cn(987654.3, to="currency", currency="USD"),
            "美元九十八万七千六百五十四元三角",
        )
        self.assertEqual(n2zh_cn(135.79, to="currency", currency="EUR"), "欧元一百三十五元七角九分")
