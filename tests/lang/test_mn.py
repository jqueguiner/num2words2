...
class Num2WordsMNTest(TestCase):
    def test_to_cardinal(self):
        ...
        self.assertEqual(num2words(2869, lang="mn"), "хоёр мянга найман зуун жаран ес")
        self.assertEqual(
            num2words(-789000125, lang="mn"),
            "хасах долоон зуун наян есөн сая зуун хорин тав",
        )
        self.assertEqual(
            num2words(84932, lang="mn"), "наян дөрвөн мянга есөн зуун гучин хоёр"
        )
    ...
    def test_to_cardinal_floats(self):
        ...
        self.assertEqual(num2words(5045.0, lang="mn"), "таван мянга дөчин тав")
        self.assertEqual(num2words(10.02, lang="mn"), "арав, зууны хоёр")
        self.assertEqual(num2words(15.007, lang="mn"), "арван тав, мянганы долоо")

    def test_to_ordinal(self):
        self.assertEqual(num2words(105, lang="mn", to="ordinal"), "зуун тав дугаар")
        self.assertEqual(
            num2words(123, lang="mn", to="ordinal"), "зуун хорин гурав дугаар"
        )
        self.assertEqual(
            num2words(540, lang="mn", to="ordinal"), "таван зуун дөч дүгээр"
        )
        self.assertEqual(num2words(79, lang="mn", to="ordinal"), "далан ес дүгээр")

        self.assertEqual(num2words(1000, lang="mn", to="ordinal"), "нэг мянга дугаар")

    def test_to_ordinal_num(self):
        self.assertEqual(num2words(105, lang="mn", to="ordinal_num"), "105 дугаар")

        self.assertEqual(num2words(489, lang="mn", to="ordinal_num"), "489 дүгээр")
