...
class Num2WordsTGTest(TestCase):
    ...
    def test_to_ordinal(self):
        ...
        self.assertEqual(num2words(136, lang="tg", to="ordinal"), "яксаду сию шашум")
        self.assertEqual(num2words(500, lang="tg", to="ordinal"), "панҷсадум")
        self.assertEqual(num2words(1000, lang="tg", to="ordinal"), "як ҳазорум")
        self.assertEqual(num2words(1001, lang="tg", to="ordinal"), "як ҳазору якум")
        self.assertEqual(num2words(2000, lang="tg", to="ordinal"), "ду ҳазорум")
        self.assertEqual(num2words(1000000, lang="tg", to="ordinal"), "як миллионум")
        self.assertEqual(
    ...
    def test_to_currency(self):
        ...
        self.assertEqual(
            num2words(12519.85, lang="tg", to="currency", currency="TJS", cents=False),
