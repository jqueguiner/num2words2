...
class TestAZ(LangTest, TestCase):
    lang = "az"
    ...
    currency_tests = [
        (0.0, "sıfır manat, sıfır qəpik", {"currency": "AZN"}),
        (0.01, "sıfır manat, bir qəpik", {"currency": "AZN"}),
        (0.1, "sıfır manat, on qəpik", {"currency": "AZN"}),
        (1.5, "bir manat, əlli qəpik", {"currency": "AZN"}),
        (1.94, "bir manat, doxsan dörd qəpik", {"currency": "AZN"}),
        (17.82, "on yeddi manat, səksən iki qəpik", {"currency": "AZN"}),
    ]
