...
class Num2WordsPLTest(TestCase):
    def test_cardinal(self):
        ...
        self.assertEqual(num2words(10.02, lang="pl"), "dziesięć przecinek zero dwa")
        self.assertEqual(
            num2words(15.007, lang="pl"), "piętnaście przecinek zero zero siedem"
        )
        self.assertEqual(
            num2words(12519.85, lang="pl"),
            "dwanaście tysięcy pięćset dziewiętnaście przecinek " "osiem pięć",
        )
        self.assertEqual(
    ...
    def test_to_ordinal(self):
        ...
        self.assertEqual(num2words(101, lang="pl", to="ordinal"), "sto pierwszy")
        self.assertEqual(num2words(120, lang="pl", to="ordinal"), "sto dwudziesty")
        self.assertEqual(num2words(20, lang="pl", to="ordinal"), "dwudziesty")
        self.assertEqual(
            num2words(121, lang="pl", to="ordinal"), "sto dwudziesty pierwszy"
        )
        self.assertEqual(num2words(115, lang="pl", to="ordinal"), "sto piętnasty")
        self.assertEqual(num2words(25, lang="pl", to="ordinal"), "dwudziesty piąty")
        self.assertEqual(
            num2words(1021, lang="pl", to="ordinal"), "tysiąc dwudziesty pierwszy"
        )
        self.assertEqual(num2words(120, lang="pl", to="ordinal"), "sto dwudziesty")
        self.assertEqual(
            num2words(1000021, lang="pl", to="ordinal"), "milion dwudziesty pierwszy"
        )
        self.assertEqual(num2words(1000, lang="pl", to="ordinal"), "tysięczny")
        self.assertEqual(
            num2words(10000, lang="pl", to="ordinal"), "dziesięciotysięczny"
        )
        self.assertEqual(num2words(100000000, lang="pl", to="ordinal"), "stumilionowy")
        self.assertEqual(
            num2words(1002000, lang="pl", to="ordinal"), "milion dwutysięczny"
        )
        self.assertEqual(
    ...
    def test_currency(self):
        self.assertEqual(
            num2words(1, lang="pl", to="currency", currency="EUR"), "jeden euro"
        )
        self.assertEqual(
            num2words(1, lang="pl", to="currency", currency="PLN"), "jeden złoty"
        )
        self.assertEqual(
    ...
    def test_negative_decimals(self):
        ...
        self.assertEqual(
            num2words(-0.04, lang="pl"), "minus zero przecinek zero cztery"
        )
