...
class Num2WordsNOTest(TestCase):
    def test_cardinal(self):
        ...
        self.assertEqual(
            num2words(1345, to="cardinal", lang="no"),
            "ett tusen tre hundre og førtifem",
        )
        self.assertEqual(
            num2words(4435, to="cardinal", lang="no"),
            "fire tusen fire hundre og trettifem",
        )
        self.assertEqual(
            num2words(1004435, to="cardinal", lang="no"),
            "en million fire tusen fire hundre og trettifem",
        )
        self.assertEqual(
            num2words(4335000, to="cardinal", lang="no"),
            "fire millioner tre hundre og trettifem tusen",
        )
        self.assertEqual(
            num2words(14004535, to="cardinal", lang="no"),
    ...
    def test_year(self):
        self.assertEqual(
            num2words(1835, to="year", lang="no"), "atten hundre og trettifem"
        )
    ...
    def test_currency(self):
        ...
        self.assertEqual(num2words(2, to="currency", lang="no"), "to kroner")
        self.assertEqual(
