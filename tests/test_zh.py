...
class Num2WordsZHTest(TestCase):
    def test_low(self):
        ...
        self.assertEqual(n2zh(2, reading="capital"), "貳")
        ...
        self.assertEqual(n2zh(6, reading="capital"), "陸")
        ...
        self.assertEqual(n2zh(12, reading="capital"), "壹拾貳")
        ...
        self.assertEqual(n2zh(16, reading="capital"), "壹拾陸")
