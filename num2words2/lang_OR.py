...
class Num2Word_OR(Num2Word_Base):
    """Odia (Oriya) number-to-words converter."""

    CURRENCY_FORMS = {
        "INR": (("ṭaṅkā", "ṭaṅkā"), ("paisā", "paisā")),
        "USD": (("ḍolāra", "ḍolāra"), ("seṇṭa", "seṇṭa")),
        "EUR": (("yuro", "yuro"), ("seṇṭa", "seṇṭa")),
    }

    def setup(self):
        self.negword = "ṛṇa "
        self.pointword = "daśamika"
        self.exclude_title = ["o", "daśamika", "ṛṇa"]
        self.ones = [
            "", "eka", "duī", "tini", "cāri", "pāñca",
            "chha", "sāta", "āṭha", "naa",
        ]
        self.teens = [
            "daśa", "egāra", "bāra", "tera", "caudaha", "pandara",
            "śohaḷa", "satara", "aṭhāra", "unīśa",
        ]
        self.tens = [
            "", "daśa", "kohi", "tirīśa", "calīśa", "paṇcāśa",
            "ṣaṣṭi", "satara", "aśī", "nabe",
        ]
        self.hundred = "śaha"
        self.thousand = "hajāra"
        self.million = "daśa lakṣa"
