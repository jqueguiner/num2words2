        ...
        if currency in self.CURRENCY_FORMS:
            ...
            if cents:
                ...
                if whole and cents == 50:
                    ...
                    result.append(self.pluralize(50, self.CURRENCY_FORMS[currency][1]))
                elif whole and cents == 25:
                    result.append("քսանհինգ")
                    result.append(self.pluralize(25, self.CURRENCY_FORMS[currency][1]))
                elif whole and cents == 75:
                    result.append("յոթանասունհինգ")
                    result.append(self.pluralize(75, self.CURRENCY_FORMS[currency][1]))
