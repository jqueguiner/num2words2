...
class Num2Word_CKB(Num2Word_Base):
    """Central Kurdish (Sorani) number-to-words converter."""

    CURRENCY_FORMS = {
        "IQD": (("dînar", "dînar"), ("fils", "fils")),
        "IRR": (("riyal", "riyal"), ("dînar", "dînar")),
    ...
    def setup(self):
        ...
        self.pointword = "xał"
        self.exclude_title = ["û", "xał", "negatîv"]
        self.ones = [
            "", "yek", "du", "sê", "çwar", "pênc",
            "şeş", "hewt", "heşt", "no",
        ]
        self.teens = [
            "de", "yanze", "dwanze", "siyanze", "çwarde", "panze",
            "şanzde", "hewde", "hejde", "nozde",
        ]
        self.tens = [
            "", "de", "bîst", "sî", "çil", "penca",
            "şest", "hefta", "heşta", "nod",
        ]
        self.hundred = "sed"
        self.thousand = "hezar"
        self.million = "milyon"
