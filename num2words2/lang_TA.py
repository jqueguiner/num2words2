...
class Num2Word_TA(Num2Word_Base):
    CURRENCY_FORMS = {
        "INR": (("ரூபாய்", "ரூபாய்"), ("பைசா", "பைசா")),
        "LKR": (("ரூபாய்", "ரூபாய்"), ("சதம்", "சதம்")),
        "USD": (("டாலர்", "டாலர்"), ("சென்ட்", "சென்ட்")),
        "EUR": (("யூரோ", "யூரோ"), ("சென்ட்", "சென்ட்")),
        "GBP": (("பவுண்ட்", "பவுண்ட்"), ("பென்னி", "பென்னி")),
        "SGD": (("டாலர்", "டாலர்"), ("சென்ட்", "சென்ட்")),
        "MYR": (("ரிங்கிட்", "ரிங்கிட்"), ("சென்", "சென்")),
    }
    ...
    def to_currency(self, n, currency="INR"):
        try:
            ...
            left, right, is_negative = parse_currency_parts(
                n, is_int_with_cents=False, keep_precision=has_fractional_cents
            )
