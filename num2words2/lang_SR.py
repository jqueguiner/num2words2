...
class Num2Word_SR(Num2Word_Base):
    CURRENCY_FORMS = {
        ...
        "EUR": (("evro", "evra", "evra", False), ("cent", "centa", "centi", False)),
        "RSD": (("dinar", "dinara", "dinara", False), ("para", "pare", "para", True)),
    }
    ...
    def to_currency(
        self, val, currency="RSD", cents=True, separator=",", adjective=False
    ):
