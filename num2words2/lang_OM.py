...
class Num2Word_OM(Num2Word_Base):
    """Oromo (Afaan Oromoo) number-to-words converter."""
    ...
    def setup(self):
        ...
        self.exclude_title = ["fi", "tuqaa", "minus"]
        self.ones = [
            "", "tokko", "lama", "sadii", "afur", "shan",
            "ja'a", "torba", "saddeet", "sagal",
        ]
        self.tens = [
            "", "kudhan", "digdama", "soddoma", "afurtama", "shantama",
            "jaatama", "torbaatama", "saddeettama", "sagaltama",
        ]
        self.hundred = "dhibba"
        self.thousand = "kuma"
        self.million = "miliyoona"
