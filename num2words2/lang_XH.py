...
class Num2Word_XH(Num2Word_Base):
    """Xhosa number-to-words converter."""
    ...
    def setup(self):
        self.negword = "ngaphantsi kwe "
        self.pointword = "ichaphaza"
        self.exclude_title = ["na", "ichaphaza", "ngaphantsi", "kwe"]
        self.ones = [
            "", "nye", "mbini", "ntathu", "ne", "ntlanu",
            "ntandathu", "sixhenxe", "sibhozo", "lithoba",
        ]
        self.tens = [
            "", "lishumi", "amashumi amabini", "amashumi amathathu", "amashumi amane", "amashumi amahlanu",
            "amashumi amathandathu", "amashumi asixhenxe", "amashumi asibhozo", "amashumi alithoba",
        ]
        self.hundred = "ikhulu"
        self.thousand = "iwaka"
