...
class Num2Word_CEB(Num2Word_Base):
    """Cebuano number-to-words converter."""
    ...
    def setup(self):
        self.negword = "minus "
        self.pointword = "puntos"
        self.exclude_title = ["minus", "puntos", "ug"]
        self.ones = [
            "", "usa", "duha", "tulo", "upat", "lima",
            "unom", "pito", "walo", "siyam",
        ]
        self.tens = [
            "", "napulo", "kawhaan", "katloan", "kap-atan", "kalim-an",
            "kan-uman", "kapitoan", "kawaloan", "kasiyaman",
        ]
        self.hundred = "gatos"
        self.thousand = "libo"
        self.million = "milyon"
