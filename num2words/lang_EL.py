    ...
    def merge(self, curr, next):
        ...
        if nnum > cnum:
            if nnum == 100:
                ...
                # Thousands - need feminine forms for hundreds
                if cnum == 2:
                    ...
                    # For other numbers ending with hundreds, adjust the form
                ...
                if cnum == 1:
                    ...
                    # For compound numbers with millions, only adjust "τέσσερα" -> "τέσσερις"
                    # Hundreds remain neuter with εκατομμύρια
                    if "τέσσερα" in ctext:
                        ctext = ctext.replace("τέσσερα", "τέσσερις")
